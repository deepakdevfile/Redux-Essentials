...
const notificationsAdaptor = createEntityAdapter<ClientNotification>({
...
const notificationsSlice = createSlice({
    ...
    extraReducers(builder){
        builder.addCase(fetchNotifications.fulfilled, (state, action) => {
            ...
            notificationsAdaptor.upsertMany(state, notificationsWithMetadata)
        })
    },
})
...
export const { selectAll: selectAllNotifications } = notificationsAdaptor.getSelectors(
